...
.value('taOptions',  {
	toolbar: [
		...
		['html', 'insertImage', 'insertLink', 'wordcount']
	],
	classes: {
		focussed: "focussed",
		toolbar: "btn-toolbar",
		toolbarGroup: "btn-group-sm",
		toolbarButton: "btn btn-success btn-raised",
...
.run(['taRegisterTool', '$window', 'taTranslations', 'taSelection', function(taRegisterTool, $window, taTranslations, taSelection){
	...
	taRegisterTool('wordcount', {
		display: '<div id="toolb  arWC" style="display:block; min-width:100px;">Words: <span ng-bind="wordcount"></span></div>',
		disabled: true,
		wordcount: 0,
